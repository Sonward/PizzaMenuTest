...
namespace PizzaMenuTest.Migrations
{
    ...
    [Migration("20240414152507_IngrindientPizzaConnection")]
    partial class IngrindientPizzaConnection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaMenuTest.Models.Entities.Ingridient", b =>
                {
                    ...
                    b.Property<int?>("PizzaIngridientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaMenuTest.Models.Entities.Ingridient", b =>
                {
                    b.HasOne("PizzaMenuTest.Models.Entities.PizzaIngridient", null)
                        .WithMany("ingridients")
                        .HasForeignKey("PizzaIngridientId");
                });
            ...
            modelBuilder.Entity("PizzaMenuTest.Models.Entities.PizzaIngridient", b =>
                {
                    b.HasOne("PizzaMenuTest.Models.Entities.Pizza", null)
                        .WithOne("Ingridients")
                        .HasForeignKey("PizzaMenuTest.Models.Entities.PizzaIngridient", "PizzaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
